...
public class Piano extends JFrame implements LineListener , KeyListener {
    //音を出したりメインの内容は全てここで済ませる。
    ...
    public static void main(String[] args){
        ...
        Timer_task timer_task = new Timer_task("Piano");
        timer_task.setPiano(piano);
